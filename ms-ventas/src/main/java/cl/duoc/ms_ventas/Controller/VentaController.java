...
public class VentaController {
    ...
    @PostMapping
    @Operation(summary = "Crear venta", description = "Registra una venta validando dueño y mascota")
    @ApiResponses({
        @ApiResponse(responseCode = "201", description = "Venta creada exitosamente"),
        @ApiResponse(responseCode = "400", description = "Dueño o mascota no existe"),
    ...
    @GetMapping
    @Operation(summary = "Listar ventas", description = "Retorna la lista completa de ventas")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Lista de ventas retornada exitosamente"),
        @ApiResponse(responseCode = "500", description = "Error interno del servidor")
    })
    ...
    public ResponseEntity<EntityModel<VentaDTO>> actualizar(@PathVariable Long id, @Valid @RequestBody VentaDTO dto) {
